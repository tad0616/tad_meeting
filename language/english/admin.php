...
define('_MA_TADMEETIN_TAD_MEETING_CATE_TITLE', 'Category title');
define('_MA_TADMEETIN_TAD_MEETING_CATE_DESC', 'Classification instructions');
define('_MA_TADMEETIN_TAD_MEETING_CATE_SORT', 'Sort order');
define('_MA_TADMEETIN_TAD_MEETING_CATE_ENABLE', 'State');
