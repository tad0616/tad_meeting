...
define('_MA_TADMEETIN_TAD_MEETING_DATETIME', '開會日期');
define('_MA_TADMEETIN_TAD_MEETING_PLACE', '會議地點');
define('_MA_TADMEETIN_TAD_MEETING_CHAIRMAN', '會議主席');
define('_MA_TADMEETIN_TAD_MEETING_SN', '會議編號');
define('_MA_TADMEETIN_TAD_MEETING_NOTE', '相關補充說明');
define('_MA_TADMEETIN_TAD_MEETING_CATE_TITLE', '分類標題');
define('_MA_TADMEETIN_TAD_MEETING_CATE_DESC', '分類說明');
define('_MA_TADMEETIN_TAD_MEETING_CATE_SORT', '分類排序');
define('_MA_TADMEETIN_TAD_MEETING_CATE_ENABLE', '狀態');
