                ...
                <div style="line-height: 1.8; padding: 10px 0px 0px 48px; text-align: justify;">
                    ...
                    <{if $tad_meeting_adm or $now_uid==$data.tad_meeting_data_uid}>
                        <div class="text-right text-end">
                            ...
                            <a href="<{$xoops_url}>/modules/tad_meeting/index.php?tad_meeting_sn=<{$tad_meeting_sn|default:''}>&tad_meeting_data_sn=<{$data.tad_meeting_data_sn}>#tad_meeting_data_form" class="btn btn-sm btn-xs btn-warning"><i class="fa fa-pen-to-square" aria-hidden="true"></i> <{$smarty.const._TAD_EDIT}></a>
