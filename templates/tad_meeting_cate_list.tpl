    ...
    <tbody id="tad_meeting_cate_sort">
      <{foreach from=$all_content item=data}>
        <tr id="tr_<{$data.tad_meeting_cate_sn}>">
          ...
          <{if $isAdmin}>
            <td>
              <a href="javascript:delete_tad_meeting_cate_func(<{$data.tad_meeting_cate_sn}>);" class="btn btn-xs btn-danger"><{$smarty.const._TAD_DEL}></a>
              <a href="<{$xoops_url}>/modules/tad_meeting/admin/main.php?op=tad_meeting_cate_form&tad_meeting_cate_sn=<{$data.tad_meeting_cate_sn}>" class="btn btn-xs btn-warning"><{$smarty.const._TAD_EDIT}></a>
