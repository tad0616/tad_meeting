  ...
  <h2 class="text-center">
    <div class="btn-group pull-right" role="group" >
      <{if $isAdmin or $create_meeting}>
        ...
        <a href="javascript:delete_tad_meeting_func(<{$tad_meeting_sn}>);" class="btn btn-xs btn-danger"><{$smarty.const._TAD_DEL}></a>
        <a href="<{$xoops_url}>/modules/tad_meeting/index.php?op=tad_meeting_form&tad_meeting_sn=<{$tad_meeting_sn}>" class="btn btn-xs btn-warning"><{$smarty.const._TAD_EDIT}></a>
        <a href="<{$xoops_url}>/modules/tad_meeting/index.php?op=tad_meeting_form" class="btn btn-xs btn-info"><{$smarty.const._MD_TADMEETIN_ADD_MEETING}></a>
      <{/if}>
      <a href="<{$action}>" class="btn btn-xs btn-success"><{$smarty.const._TAD_HOME}></a>
    </div>
    <{$tad_meeting_title}>
  </h2>
